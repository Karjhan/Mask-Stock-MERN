...
import AddNewLogo from "../images/add_new_header.png";
import OrderLogo from "../images/order_header.png";
        ...
        <Row>
            <Col style={{ padding: "0", width: "100%" }}>
                <Routes>
                    ...
                    <Route path="/order" element={<Image fluid src={OrderLogo} alt=""></Image>} />
                    <Route path="/add-new" element={<Image fluid src={AddNewLogo} alt=""></Image>} />
                </Routes>
